...
/**
 * Find yellow totes based on retroreflective target.
 * This class utilizes an image file, which you need to copy to the roboRIO
 ...
 */
public class BrandonVisionNotASubsystem extends SampleRobot
{
		...
		public void autonomous()
		{
			//while (isAutonomous() && isEnabled())
			{
				...
				*/
				...
				//NIVision.imaqReadFile(frame, "/home/lvuser/Images/IMG_3037.JPG");				
				//NIVision.imaqReadFile(frame, "/home/lvuser/Images/image.jpg");
				//NIVision.imaqReadFile(frame, "/home/lvuser/Images/image20.jpg");
				
				//have to send the image to the dashboard multiple times to show the image up
				for (int i =0; i<5; i++)
				{
					CameraServer.getInstance().setImage(frame);
				}
